...
public class GestoreRichiestaFerie {
    ...
    public void richiediFerie(LocalDate data_inizio, LocalDate data_fine,Stage s){
        ...
        long giorni = ChronoUnit.DAYS.between(data_inizio, data_fine)+1;
        ...
        if(DBMS.controllaPeriodo(data_inizio,data_fine)){
            if(!DBMS.controllaAstensione(data_inizio,data_fine,GestoreLogin.getUtente().getMatricola())) {
